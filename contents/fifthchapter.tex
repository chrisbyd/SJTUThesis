...
\begin{figure}[!htp]
    ...
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/cifar16b.pdf}
      \caption{16位哈希码下在\textbf{CIFAR-10}上各种方法的\textbf{PR}曲线}
    \end{subfigure}
    \hspace{1cm}
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/cifar32.pdf}
      \caption{32位哈希码下在\textbf{CIFAR-10}上各种方法的\textbf{PR}曲线}
    \end{subfigure}
    \bicaption[各种算法损失函数在\textbf{CIFAR-10}上的结果]{
        \textbf{APQ}量化损失和其他两种量化损失函数在\textbf{CIFAR-10}数据集上的结果}{The experimental results on \textbf{CIFAR-10}  of \textbf{APQ} and other quantization losses }
    \label{fig:abloss1}
  \end{figure}
  \begin{figure}[!htp]
    \centering
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/cifar64b.pdf}
      \caption{64位哈希码下在\textbf{CIFAR-10}上各种方法的\textbf{PR}曲线}
    \end{subfigure}
    \hspace{1cm}
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/imagenet16b.pdf}
      \caption{16位哈希码下在\textbf{IMAGENET}上各种方法的\textbf{PR}曲线}
    \end{subfigure}
    \bicaption[各种量化损失函数在两个数据集上的结果]{
        \textbf{APQ}量化损失和其他两种量化损失函数在两个数据集上的结果}{The experimental results on two datasets of \textbf{APQ} and other quantization losses }
    \label{fig:abloss2}
  \end{figure}
  \begin{figure}[!htp]
    \centering
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/imagenet32b.pdf}
      \caption{32位哈希码下在\textbf{IMAGENET}上各种方法的\textbf{PR}曲线}
    \end{subfigure}
    \hspace{1cm}
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/imagenet64b.pdf}
      \caption{64位哈希码下在\textbf{IMAGENET}上各种方法的\textbf{PR}曲线}
    \end{subfigure}
    \bicaption[各种量化损失函数在\textbf{IMAGENET}上的结果]{
        \textbf{APQ}量化损失和其他两种量化损失函数在\textbf{IMAGENET}数据集上的结果}{The experimental results on \textbf{IMAGENET}  of \textbf{APQ} and other quantization losses }
    \label{fig:abloss3}
  \end{figure}
...
\begin{figure}[!htp]
    ...
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/absym_cifar16b_anno.pdf}
      \caption{16位哈希码下在\textbf{CIFAR-10}上\textbf{APQ}和\textbf{FastAP}的性能比较}
    \end{subfigure}
    \hspace{1cm}
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/absym_imagenet16b_anno.pdf}
  ...
  \begin{figure}[!htp]
    ...
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/apq_tsne_anno.pdf}
      \caption{16位哈希码下在\textbf{CIFAR-10}上\textbf{APQ}的深度特征t-SNE可视化}
    \end{subfigure}
    \hspace{1cm}
    \begin{subfigure}{\textwidth}
      \centering
      \includegraphics[height=8cm]{05/fastap_tsne_anno.pdf}
