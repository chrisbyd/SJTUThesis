...
\begin{figure}[!htp]\ContinuedFloat
  ...
  \bicaption[现有算法在两个数据集不同的哈希码长度下的性能比较结果]{各种现有算法在不同的哈希长度下在两个车辆检索公共数据集下的性能比较}{The vehicle re-identification results of different state-of-the-arts on two public benchmark datasets of varied hashing lengths.}
